...
var _class = function (_Component) {
	...
	function _class(props) {
		...
		_this.loadMore = function () {
			...
			var nextPage = page + 1;
			var offset = (Number(nextPage) - 1) * 25;
			if (searchValue) {
				_this.searchGifs(offset);
			} else {
				_this.loadTrendingGifs(offset);
			}
		};
	...
	_createClass(_class, [{
		...
		value: function loadTrendingGifs(offset) {
			...
			fetch(url, {
				...
				var gifs = response.data.map(function (g) {
					return g.images;
				});
				var hasMore = true;
				var _response$pagination = response.pagination,
				    total_count = _response$pagination.total_count,
				    count = _response$pagination.count,
				    offset = _response$pagination.offset;
		...
		value: function searchGifs(offset) {
			...
			fetch(url, {
				...
				var hasMore = true;
				var _response$pagination2 = response.pagination,
				    total_count = _response$pagination2.total_count,
				    count = _response$pagination2.count,
				    offset = _response$pagination2.offset;
							...
							gifs.map(function (g, i) {
								...
								return _react2.default.createElement(Giphy, {
									style: {
										...
										backgroundColor: _this5.props.imagePlaceholderColor
									},
									key: i,
		...
		get: function get() {
			return {
				...
				imagePlaceholderColor: _propTypes2.default.string,
